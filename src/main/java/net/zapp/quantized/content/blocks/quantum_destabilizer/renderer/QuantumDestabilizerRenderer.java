...
public class QuantumDestabilizerRenderer implements BlockEntityRenderer<QuantumDestabilizerTile> {
    ...
    private float getScale(QuantumDestabilizerTile blockEntity, float partialTick) {
        return Mth.lerp(partialTick, blockEntity.prevScale, blockEntity.scale);
    }

    private float getRotation(QuantumDestabilizerTile blockEntity, float partialTick) {
